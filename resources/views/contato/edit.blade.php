    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                <form method="post" action="{{ route('contato.update', ['contato' => $contato->id]) }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="email" value="{{ $contato->email ?? old('email') }}" placeholder="Email" class="borda-preta">
